...
namespace EddiConfigService
{
    public partial class ConfigService
    {
        ...
        /// </summary>
        private void ToFile(Config value, string directory = null)
        {
            if (directory == null) { directory = Constants.DATA_DIR; }
            string filename = directory + (value.GetType().GetCustomAttribute(typeof(RelativePathAttribute)) as RelativePathAttribute)?.relativePath;
