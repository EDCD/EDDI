...
namespace EddiDataDefinitions
{
    public class CodexStellarBody : ResourceBasedLocalizedEDName<CodexStellarBody>
    {
        ...
        public static readonly CodexStellarBody Green_Giant_With_Ammonia_Life =
            new( "Green_Giant_With_Ammonia_Life", 1200402, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Sudarsky_Class_I =
            new( "Green_Sudarsky_Class_I", 1200502, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Sudarsky_Class_II =
            new( "Green_Sudarsky_Class_II", 1200602, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Sudarsky_Class_III =
            new( "Green_Sudarsky_Class_III", 1200702, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Sudarsky_Class_IV =
            new( "Green_Sudarsky_Class_IV", 1200802, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Sudarsky_Class_V =
            new( "Green_Sudarsky_Class_V", 1200902, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Water_Giant =
            new( "Green_Water_Giant", 1200102, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Green_Giant_With_Water_Life =
            new( "Green_Giant_With_Water_Life", 1200302, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Giant_With_Ammonia_Life =
            new( "Standard_Giant_With_Ammonia_Life", 1200401, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Giant_With_Water_Life =
            new( "Standard_Giant_With_Water_Life", 1200301, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Helium =
            new( "Standard_Helium", null, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Helium_Rich =
            new( "Standard_Helium_Rich", 1201001, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Sudarsky_Class_I =
            new( "Standard_Sudarsky_Class_I", 1200501, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Sudarsky_Class_II =
            new( "Standard_Sudarsky_Class_II", 1200601, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Sudarsky_Class_III =
            new( "Standard_Sudarsky_Class_III", 1200701, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Sudarsky_Class_IV =
            new( "Standard_Sudarsky_Class_IV", 1200801, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Sudarsky_Class_V =
            new( "Standard_Sudarsky_Class_V", 1200901, CodexStellarBodyType.GasGiants );

        public static readonly CodexStellarBody Standard_Water_Giant =
            new( "Standard_Water_Giant", 1200101, CodexStellarBodyType.GasGiants );
        ...
        public static readonly CodexStellarBody A_TypeSuperGiant =
            new( "A_TypeSuperGiant", 1100303, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody B_TypeSuperGiant =
            new( "B_TypeSuperGiant", 1100203, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody C_TypeHyperGiant =
            new( "C_TypeHyperGiant", 1101404, CodexStellarBodyType.Stars );

        public static readonly CodexStellarBody C_TypeSuperGiant =
            new( "C_TypeSuperGiant", 1101403, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody F_TypeSuperGiant =
            new( "F_TypeSuperGiant", 1100403, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody G_TypeSuperGiant =
            new( "G_TypeSuperGiant", 1100503, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody K_TypeSuperGiant =
            new( "K_TypeSuperGiant", 1100603, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody M_TypeSuperGiant =
            new( "M_TypeSuperGiant", 1100703, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody Neutron_Stars =
            new( "Neutron_Stars", 1102300, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody O_TypeSuperGiant =
            new( "O_TypeSuperGiant", 1100103, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody SupermassiveBlack_Holes =
            new( "SupermassiveBlack_Holes", 1102500, CodexStellarBodyType.Stars );
        ...
        public static readonly CodexStellarBody Earth_Likes =
            new( "Earth_Likes", 1300100, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ammonia_Worlds =
            new( "Standard_Ammonia_Worlds", 1300202, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_High_Metal_Content_No_Atmos =
            new( "Standard_High_Metal_Content_No_Atmos", 1300501, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ice_No_Atmos =
            new( "Standard_Ice_No_Atmos", 1300801, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Metal_Rich_No_Atmos =
            new( "Standard_Metal_Rich_No_Atmos", 1300401, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Rocky_Ice_No_Atmos =
            new( "Standard_Rocky_Ice_No_Atmos", 1300701, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Rocky_No_Atmos =
            new( "Standard_Rocky_No_Atmos", 1300601, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ter_High_Metal_Content =
            new( "Standard_Ter_High_Metal_Content", 1301501, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ter_Ice =
            new( "Standard_Ter_Ice", 1301801, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ter_Metal_Rich =
            new( "Standard_Ter_Metal_Rich", 1301401, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ter_Rocky_Ice =
            new( "Standard_Ter_Rocky_Ice", 1301701, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Ter_Rocky =
            new( "Standard_Ter_Rocky", 1301601, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody Standard_Water_Worlds =
            new( "Standard_Water_Worlds", 1300301, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Ammonia_Worlds =
            new( "TRF_Ammonia_Worlds", null, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_High_Metal_Content_No_Atmos =
            new( "TRF_High_Metal_Content_No_Atmos", 1300502, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Rocky_No_Atmos =
            new( "TRF_Rocky_No_Atmos", 1300602, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Ter_High_Metal_Content =
            new( "TRF_Ter_High_Metal_Content", 1301502, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Ter_Metal_Rich =
            new( "TRF_Ter_Metal_Rich", null, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Ter_Rocky =
            new( "TRF_Ter_Rocky", 1301602, CodexStellarBodyType.Terrestrials );

        public static readonly CodexStellarBody TRF_Water_Worlds =
            new( "TRF_Water_Worlds", 1300302, CodexStellarBodyType.Terrestrials );
