    ...
    public class CommodityDefinition : ResourceBasedLocalizedEDName<CommodityDefinition>
    {
        ...
        static CommodityDefinition()
        {
            ...
            var _ = new List<CommodityDefinition>
            {
                ...
                new CommodityDefinition(128667031, 93, "Wolf1301Fesh", Narcotics, 8399, true),
                ...
                new CommodityDefinition(128667042, 153, "CD75CatCoffee", Foods, 9571, true),
                ...
                new CommodityDefinition(128667055, 166, "AerialEdenApple", Foods, 8331, true),
                ...
                new CommodityDefinition(128667076, 185, "SanumaMEAT", Foods, 8504, true),
                ...
                new CommodityDefinition(128667696, 220, "UzumokuLowGWings", ConsumerItems, 13845, true),
                ...
                new CommodityDefinition(128671289, null, "AislingMediaMaterials", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671290, null, "AislingMediaResources", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671291, null, "AislingPromotionalMaterials", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671292, null, "AllianceTradeAgreements", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671293, null, "AllianceLegaslativeContracts", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671294, null, "AllianceLegaslativeRecords", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671295, null, "LavignyCorruptionDossiers", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671296, null, "LavignyFieldSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671297, null, "LavignyGarisonSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671298, null, "RestrictedPackage", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671300, null, "LiberalCampaignMaterials", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671301, null, "FederalAid", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671302, null, "FederalTradeContracts", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671303, null, "LoanedArms", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671304, null, "PatreusFieldSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671305, null, "PatreusGarisonSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671306, null, "RestrictedIntel", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671307, null, "RepublicanFieldSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671308, null, "RepublicanGarisonSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671309, null, "SiriusFranchisePackage", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671310, null, "SiriusCommercialContracts", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671311, null, "SiriusIndustrialEquipment", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671312, null, "TorvalCommercialContracts", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671313, null, "ImperialPrisoner", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671314, null, "UtopianPublicity", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671315, null, "UtopianFieldSupplies", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671316, null, "UtopianDissident", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671317, null, "IllicitConsignment", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671318, null, "UnmarkedWeapons", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671319, null, "OnionheadSamples", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671320, null, "CounterCultureSupport", Powerplay, 0, false), // PowerPlay
                ...
                new CommodityDefinition(128671445, null, "MarkedSlaves", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671446, null, "TorvalDeeds", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671447, null, "OnionheadDerivatives", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128671450, null, "OutOfDateGoods", Powerplay, 0, false), // PowerPlay
                ...
                new CommodityDefinition(128672159, 333, "AntiqueJewellery", Salvage, 0, false),
                ...
                new CommodityDefinition(128672162, 334, "GeneBank", Salvage, 0, false),
                new CommodityDefinition(128672163, 335, "TimeCapsule", Salvage, 0, false),
                ...
                new CommodityDefinition(128672431, 353, "PersonalGifts", ConsumerItems, 16535, false),
                ...
                new CommodityDefinition(128732183, 321, "AncientRelic", Salvage, 24962, false),
                new CommodityDefinition(128732184, 322, "AncientOrb", Salvage, 17415, false),
                new CommodityDefinition(128732185, 323, "AncientCasket", Salvage, 16294, false),
                new CommodityDefinition(128732186, 324, "AncientTablet", Salvage, 17415, false),
                new CommodityDefinition(128732187, 325, "AncientUrn", Salvage, 14907, false),
                new CommodityDefinition(128732188, 326, "AncientTotem", Salvage, 20437, false),
                new CommodityDefinition(128732548, null, "UndergroundSupport", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128732549, null, "GromCounterIntelligence", Powerplay, 0, false), // PowerPlay
                new CommodityDefinition(128732550, null, "GromWarTrophies", Powerplay, 0, false), // PowerPlay
                ...
                new CommodityDefinition(128888499, 326, "AncientKey", Salvage, 29931, false),
                new CommodityDefinition(128902652, 340, "ThargoidTissueSampleType4", Salvage, 0, false),
                new CommodityDefinition(128913661, 341, "Nanomedicines", Medicines, 9859, true),
                new CommodityDefinition(128922517, 363, "M_TissueSample_Fluid", Salvage, 0, false),
                new CommodityDefinition(128922518, 364, "M_TissueSample_Soft", Salvage, 0, false),
                new CommodityDefinition(128922519, 365, "M_TissueSample_Nerves", Salvage, 0, false),
                new CommodityDefinition(128922520, 366, "S_TissueSample_Cells", Salvage, 0, false),
                new CommodityDefinition(128922521, 367, "S_TissueSample_Surface", Salvage, 0, false),
                new CommodityDefinition(128922522, 368, "S_TissueSample_Core", Salvage, 0, false),
                new CommodityDefinition(128922523, 369, "P_ParticulateSample", Salvage, 0, false),
                new CommodityDefinition(128922524, 342, "Duradrives", ConsumerItems, 19356, true),
                new CommodityDefinition(128922781, 370, "S9_TissueSample_Shell", Salvage, 0, false),
                new CommodityDefinition(128922782, 371, "M3_TissueSample_Membrane", Salvage, 0, false),
                new CommodityDefinition(128922783, 372, "M3_TissueSample_Mycelium", Salvage, 0, false),
                new CommodityDefinition(128922784, 373, "M3_TissueSample_Spores", Salvage, 0, false),
                new CommodityDefinition(128922785, 374, "S6_TissueSample_Mesoglea", Salvage, 0, false),
                new CommodityDefinition(128922786, 375, "S6_TissueSample_Cells", Salvage, 0, false),
                new CommodityDefinition(128922787, 376, "S6_TissueSample_Coenosarc", Salvage, 0, false),
                new CommodityDefinition(128924325, 343, "Rhodplumsite", Minerals, 176791, false),
                new CommodityDefinition(128924326, 344, "Serendibite", Minerals, 172634, false),
                new CommodityDefinition(128924327, 345, "Monazite", Minerals, 200925, false),
                new CommodityDefinition(128924328, 346, "Musgravite", Minerals, 198527, false),
                new CommodityDefinition(128924329, 347, "Benitoite", Minerals, 149325, false),
                new CommodityDefinition(128924330, 348, "Grandidierite", Minerals, 197204, false),
                new CommodityDefinition(128924331, 349, "Alexandrite", Minerals, 217192, false),
                new CommodityDefinition(128924332, 350, "Opal", Minerals, 135218, false),
                new CommodityDefinition(128924333, 359, "RockforthFertiliser", Chemicals, 8, false),
        ...
        internal CommodityDefinition(long EliteID, long? EDDBID, string edname, CommodityCategory Category, decimal AveragePrice = 0, bool Rare = false) : base(edname, edname)
        {
