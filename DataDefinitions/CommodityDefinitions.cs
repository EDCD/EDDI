...
namespace EddiDataDefinitions
{
    public class CommodityDefinitions
    {
        ...
        // Check https://eddb.io/archive/v5/commodities.json (for any undefined EDDBID's or undefined FDevID's) and https://github.com/EDCD/FDevIDs (for any undefined FDevID's)
        {
            ...
            {128667030, new Commodity(91, "TarachTorSpice", "Tarach Spice", "Narcotics", 8642, true) },
            ...
            {128667021, new Commodity(136, "UtgaroarMillenialEggs", "Utgaroar Millennial Eggs", "Foods", 9163, true) },
            ...
            {128667670, new Commodity(195, "CetiAepyornisEgg", "Aepyornis Egg", "Foods", 9769, true) },
            ...
            {200000016, new Commodity(10016, "lavignygarisonsupplies", "Lavigny Garrison Supplies", "Powerplay", 0, false) },
