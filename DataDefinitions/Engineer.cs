...
namespace EddiDataDefinitions
{
    ...
    public class Engineer
    {
        ...
        public static readonly Engineer RamTah = new Engineer(300110, "Ram Tah", "Meene", 3790082132323, "Phoenix Base", 128676743, new HashSet<EngineerSpecialty> { EngineerSpecialty.ECMs, EngineerSpecialty.PointDefenses, EngineerSpecialty.ChaffAndHeatSinkLaunchers }, new HashSet<EngineerSpecialty> { EngineerSpecialty.LimpetControllers });
        ...
        public static readonly Engineer PetraOlmanova = new Engineer(300130, "Petra Olmanova", "Asura", 12274907287851, "Sanctuary", 128677255, new HashSet<EngineerSpecialty> { EngineerSpecialty.HullReinforcement, EngineerSpecialty.Missiles, EngineerSpecialty.ChaffAndHeatSinkLaunchers, EngineerSpecialty.PointDefenses }, new HashSet<EngineerSpecialty> {EngineerSpecialty.Mines, EngineerSpecialty.Torpedos, EngineerSpecialty.ECMs, EngineerSpecialty.AFMUs});
