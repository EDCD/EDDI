...
namespace EddiDataDefinitions
{
    public class GuardianItem
    {
        ...
        public GuardianItem ( string name, string desc )
        {
            exists = true;
            this.name = name;
    ...
    static class GuardianInfo
    {
        public static ResourceManager rmGuardianName = new ResourceManager("EddiDataDefinitions.Properties.GuardianName", Assembly.GetExecutingAssembly());
        ...
        public static GuardianItem Lookup ( long? entryId, string edname )
        {
            GuardianItem item = new GuardianItem();
        ...
        public static GuardianItem LookupByEntryId ( long? entryId )
        {
            GuardianItem item = new GuardianItem();
            ...
            if ( entryId != null )
            {
                if ( EntryIdData.ContainsKey( (long)entryId ) )
                {
                    ...
                    item.name = rmGuardianName.GetString( data.edname );
                    item.description = rmGuardianDesc.GetString( data.edname );
        ...
        public static GuardianItem LookupByName ( string edname )
        {
            GuardianItem item = new GuardianItem();

            if ( edname != "" )
            {
                item.name = rmGuardianName.GetString( edname );
                item.description = rmGuardianDesc.GetString( edname );
