...
namespace EddiDataDefinitions
{
    public class MarketInfoItem
    {
        ...
        public MarketInfoItem(MarketInfoItem MarketInfo)
        {
        ...
        public MarketInfoItem(long id, string Name, string Category, int BuyPrice, int SellPrice, int MeanPrice, CommodityBracket? StockBracket, CommodityBracket? DemandBracket, int Stock, int Demand, bool Consumer, bool Producer, bool Rare)
        {
            this.id = id;
            this.name = Name;
