...
namespace EddiDataDefinitions
{
    ...
    public class MicroResource : ResourceBasedLocalizedEDName<MicroResource>
    {
        ...
        // Items
        public static readonly MicroResource AgriculturalProcessSample = new MicroResource("AgriculturalProcessSample", MicroResourceCategory.Components, 128965837);
        public static readonly MicroResource BiochemicalAgent = new MicroResource("BiochemicalAgent", MicroResourceCategory.Components, 128961554);
        public static readonly MicroResource BuildingSchematic = new MicroResource("BuildingSchematic", MicroResourceCategory.Components, 128962597);
        public static readonly MicroResource Californium = new MicroResource("Californium", MicroResourceCategory.Components, 128961556);
        public static readonly MicroResource CastFossil = new MicroResource("CastFossil", MicroResourceCategory.Components, 128961557);
        public static readonly MicroResource ChemicalProcessSample = new MicroResource("ChemicalProcessSample", MicroResourceCategory.Components, 128965838);
        public static readonly MicroResource ChemicalSample = new MicroResource("ChemicalSample", MicroResourceCategory.Components, 128959449);
        public static readonly MicroResource CompactLibrary = new MicroResource("CompactLibrary", MicroResourceCategory.Components, 128962598);
        public static readonly MicroResource CompressionLiquefiedGas = new MicroResource("CompressionLiquefiedGas", MicroResourceCategory.Components, 128965840);
        public static readonly MicroResource DeepMantleSample = new MicroResource("DeepMantleSample", MicroResourceCategory.Components, 128962599);
        public static readonly MicroResource DegradedPowerRegulator = new MicroResource("DegradedPowerRegulator", MicroResourceCategory.Components, 128965841);
        public static readonly MicroResource GeneticRepairMeds = new MicroResource("GeneticRepairMeds", MicroResourceCategory.Components, 128962315);
        public static readonly MicroResource GeneticSample = new MicroResource("GeneticSample", MicroResourceCategory.Components, 128961564);
        public static readonly MicroResource GMeds = new MicroResource("GMeds", MicroResourceCategory.Components, 128961565);
        public static readonly MicroResource HealthMonitor = new MicroResource("HealthMonitor", MicroResourceCategory.Components, 128961566);
        public static readonly MicroResource Hush = new MicroResource("Hush", MicroResourceCategory.Components, 128962600);
        public static readonly MicroResource InertiaCanister = new MicroResource("InertiaCanister", MicroResourceCategory.Components, 128961567);
        public static readonly MicroResource Infinity = new MicroResource("Infinity", MicroResourceCategory.Components, 128962601);
        public static readonly MicroResource InorganicContaminant = new MicroResource("InorganicContaminant", MicroResourceCategory.Components, 128965836);
        public static readonly MicroResource Insight = new MicroResource("Insight", MicroResourceCategory.Components, 128961568);
        public static readonly MicroResource InsightDataBank = new MicroResource("InsightDataBank", MicroResourceCategory.Components, 128961569);
        public static readonly MicroResource InsightEntertainmentSuite = new MicroResource("InsightEntertainmentSuite", MicroResourceCategory.Components, 128962602);
        public static readonly MicroResource IonisedGas = new MicroResource("IonisedGas", MicroResourceCategory.Components, 128961570);
        public static readonly MicroResource LargeCapacityPowerRegulator = new MicroResource("LargeCapacityPowerRegulator", MicroResourceCategory.Components, 128965842);
        public static readonly MicroResource Lazarus = new MicroResource("Lazarus", MicroResourceCategory.Components, 128962603);
        public static readonly MicroResource MicrobialInhibitor = new MicroResource("MicrobialInhibitor", MicroResourceCategory.Components, 128962604);
        public static readonly MicroResource MutagenicCatalyst = new MicroResource("MutagenicCatalyst", MicroResourceCategory.Components, 128961571);
        public static readonly MicroResource NutritionalConcentrate = new MicroResource("NutritionalConcentrate", MicroResourceCategory.Components, 128962605);
        public static readonly MicroResource PersonalComputer = new MicroResource("PersonalComputer", MicroResourceCategory.Components, 128961584);
        public static readonly MicroResource PersonalDocuments = new MicroResource("PersonalDocuments", MicroResourceCategory.Components, 128962606);
        public static readonly MicroResource PetrifiedFossil = new MicroResource("PetrifiedFossil", MicroResourceCategory.Components, 128961586);
        public static readonly MicroResource Push = new MicroResource("Push", MicroResourceCategory.Components, 128962607);
        public static readonly MicroResource PyrolyticCatalyst = new MicroResource("PyrolyticCatalyst", MicroResourceCategory.Components, 128965835);
        public static readonly MicroResource RefinementProcessSample = new MicroResource("RefinementProcessSample", MicroResourceCategory.Components, 128965839);
        public static readonly MicroResource ShipSchematic = new MicroResource("ShipSchematic", MicroResourceCategory.Components, 128962608);
        public static readonly MicroResource SuitSchematic = new MicroResource("SuitSchematic", MicroResourceCategory.Components, 128962609);
        public static readonly MicroResource SurveillanceEquipment = new MicroResource("SurveillanceEquipment", MicroResourceCategory.Components, 128962610);
        public static readonly MicroResource SyntheticGenome = new MicroResource("SyntheticGenome", MicroResourceCategory.Components, 128961590);
        public static readonly MicroResource SyntheticPathogen = new MicroResource("SyntheticPathogen", MicroResourceCategory.Components, 128962611);
        public static readonly MicroResource TrueFormFossil = new MicroResource("TrueFormFossil", MicroResourceCategory.Components, 128961591);
        public static readonly MicroResource UniversalTranslator = new MicroResource("UniversalTranslator", MicroResourceCategory.Components, 128962612);
        public static readonly MicroResource VehicleSchematic = new MicroResource("VehicleSchematic", MicroResourceCategory.Components, 128962613);
        public static readonly MicroResource WeaponSchematic = new MicroResource("WeaponSchematic", MicroResourceCategory.Components, 128962614);
