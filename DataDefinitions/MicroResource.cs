...
namespace EddiDataDefinitions
{
    ...
    public class MicroResource : ResourceBasedLocalizedEDName<MicroResource>
    {
        ...
        // Components
        public static readonly MicroResource Aerogel = new MicroResource("Aerogel", MicroResourceCategory.Component, 128961524);
        public static readonly MicroResource CarbonFibrePlating = new MicroResource("CarbonFibrePlating", MicroResourceCategory.Component, 128961526);
        public static readonly MicroResource ChemicalCatalyst = new MicroResource("ChemicalCatalyst", MicroResourceCategory.Component, 128961527);
        public static readonly MicroResource ChemicalSuperbase = new MicroResource("ChemicalSuperbase", MicroResourceCategory.Component, 128961528);
        public static readonly MicroResource CircuitBoard = new MicroResource("CircuitBoard", MicroResourceCategory.Component, 128961529);
        public static readonly MicroResource CircuitSwitch = new MicroResource("CircuitSwitch", MicroResourceCategory.Component, 128961530);
        public static readonly MicroResource ElectricalFuse = new MicroResource("ElectricalFuse", MicroResourceCategory.Component, 128961531);
        public static readonly MicroResource ElectricalWiring = new MicroResource("ElectricalWiring", MicroResourceCategory.Component, 128961532);
        public static readonly MicroResource Electromagnet = new MicroResource("Electromagnet", MicroResourceCategory.Component, 128962573);
        public static readonly MicroResource EncryptedMemoryChip = new MicroResource("EncryptedMemoryChip", MicroResourceCategory.Component, 128961533);
        public static readonly MicroResource Epinephrine = new MicroResource("Epinephrine", MicroResourceCategory.Component, 128962575);
        public static readonly MicroResource EpoxyAdhesive = new MicroResource("EpoxyAdhesive", MicroResourceCategory.Component, 128961534);
        public static readonly MicroResource Graphene = new MicroResource("Graphene", MicroResourceCategory.Component, 128064021);
        public static readonly MicroResource IonBattery = new MicroResource("IonBattery", MicroResourceCategory.Component, 128965844);
        public static readonly MicroResource MemoryChip = new MicroResource("MemoryChip", MicroResourceCategory.Component, 128961537);
        public static readonly MicroResource MetalCoil = new MicroResource("MetalCoil", MicroResourceCategory.Component, 128961538);
        public static readonly MicroResource MicroElectrode = new MicroResource("MicroElectrode", MicroResourceCategory.Component, 128964025);
        public static readonly MicroResource MicroHydraulics = new MicroResource("MicroHydraulics", MicroResourceCategory.Component, 128961539);
        public static readonly MicroResource MicroSuperCapacitor = new MicroResource("MicroSuperCapacitor", MicroResourceCategory.Component, 128961540);
        public static readonly MicroResource MicroThrusters = new MicroResource("MicroThrusters", MicroResourceCategory.Component, 128961541);
        public static readonly MicroResource MicroTransformer = new MicroResource("MicroTransformer", MicroResourceCategory.Component, 128961542);
        public static readonly MicroResource Motor = new MicroResource("Motor", MicroResourceCategory.Component, 128961543);
        public static readonly MicroResource OpticalFibre = new MicroResource("OpticalFibre", MicroResourceCategory.Component, 128961544);
        public static readonly MicroResource OpticalLens = new MicroResource("OpticalLens", MicroResourceCategory.Component, 128961545);
        public static readonly MicroResource OxygenicBacteria = new MicroResource("OxygenicBacteria", MicroResourceCategory.Component, 128962574);
        public static readonly MicroResource pHNeutraliser = new MicroResource("pHNeutraliser", MicroResourceCategory.Component, 128962576);
        public static readonly MicroResource RDX = new MicroResource("RDX", MicroResourceCategory.Component, 128962572);
        public static readonly MicroResource Scrambler = new MicroResource("Scrambler", MicroResourceCategory.Component, 128961547);
        public static readonly MicroResource TitaniumPlating = new MicroResource("TitaniumPlating", MicroResourceCategory.Component, 128961549);
        public static readonly MicroResource Transmitter = new MicroResource("Transmitter", MicroResourceCategory.Component, 128961550);
        public static readonly MicroResource TungstenCarbide = new MicroResource("TungstenCarbide", MicroResourceCategory.Component, 128961551);
        public static readonly MicroResource ViscoelasticPolymer = new MicroResource("ViscoelasticPolymer", MicroResourceCategory.Component, 128961552);
        public static readonly MicroResource WeaponComponent = new MicroResource("WeaponComponent", MicroResourceCategory.Component, 128965845);

        // Consumables
        public static readonly MicroResource Amm_Grenade_Frag = new MicroResource("Amm_Grenade_Frag", MicroResourceCategory.Consumable, 128951162);
        public static readonly MicroResource Amm_Grenade_EMP = new MicroResource("Amm_Grenade_EMP", MicroResourceCategory.Consumable, 128951161);
        public static readonly MicroResource Amm_Grenade_Shield = new MicroResource("Amm_Grenade_Shield", MicroResourceCategory.Consumable, 128951163);
        public static readonly MicroResource Bypass = new MicroResource("Bypass", MicroResourceCategory.Consumable, 128961251);
        public static readonly MicroResource EnergyCell = new MicroResource("EnergyCell", MicroResourceCategory.Consumable, 128941245);
        public static readonly MicroResource HealthPack = new MicroResource("HealthPack", MicroResourceCategory.Consumable, 128932270);
        ...
        // Items
        public static readonly MicroResource AgriculturalProcessSample = new MicroResource("AgriculturalProcessSample", MicroResourceCategory.Component, 128965837);
        public static readonly MicroResource BiochemicalAgent = new MicroResource("BiochemicalAgent", MicroResourceCategory.Component, 128961554);
        public static readonly MicroResource BuildingSchematic = new MicroResource("BuildingSchematic", MicroResourceCategory.Component, 128962597);
        public static readonly MicroResource Californium = new MicroResource("Californium", MicroResourceCategory.Component, 128961556);
        public static readonly MicroResource CastFossil = new MicroResource("CastFossil", MicroResourceCategory.Component, 128961557);
        public static readonly MicroResource ChemicalProcessSample = new MicroResource("ChemicalProcessSample", MicroResourceCategory.Component, 128965838);
        public static readonly MicroResource ChemicalSample = new MicroResource("ChemicalSample", MicroResourceCategory.Component, 128959449);
        public static readonly MicroResource CompactLibrary = new MicroResource("CompactLibrary", MicroResourceCategory.Component, 128962598);
        public static readonly MicroResource CompressionLiquefiedGas = new MicroResource("CompressionLiquefiedGas", MicroResourceCategory.Component, 128965840);
        public static readonly MicroResource DeepMantleSample = new MicroResource("DeepMantleSample", MicroResourceCategory.Component, 128962599);
        public static readonly MicroResource DegradedPowerRegulator = new MicroResource("DegradedPowerRegulator", MicroResourceCategory.Component, 128965841);
        public static readonly MicroResource GeneticRepairMeds = new MicroResource("GeneticRepairMeds", MicroResourceCategory.Component, 128962315);
        public static readonly MicroResource GeneticSample = new MicroResource("GeneticSample", MicroResourceCategory.Component, 128961564);
        public static readonly MicroResource GMeds = new MicroResource("GMeds", MicroResourceCategory.Component, 128961565);
        public static readonly MicroResource HealthMonitor = new MicroResource("HealthMonitor", MicroResourceCategory.Component, 128961566);
        public static readonly MicroResource Hush = new MicroResource("Hush", MicroResourceCategory.Component, 128962600);
        public static readonly MicroResource InertiaCanister = new MicroResource("InertiaCanister", MicroResourceCategory.Component, 128961567);
        public static readonly MicroResource Infinity = new MicroResource("Infinity", MicroResourceCategory.Component, 128962601);
        public static readonly MicroResource InorganicContaminant = new MicroResource("InorganicContaminant", MicroResourceCategory.Component, 128965836);
        public static readonly MicroResource Insight = new MicroResource("Insight", MicroResourceCategory.Component, 128961568);
        public static readonly MicroResource InsightDataBank = new MicroResource("InsightDataBank", MicroResourceCategory.Component, 128961569);
        public static readonly MicroResource InsightEntertainmentSuite = new MicroResource("InsightEntertainmentSuite", MicroResourceCategory.Component, 128962602);
        public static readonly MicroResource IonisedGas = new MicroResource("IonisedGas", MicroResourceCategory.Component, 128961570);
        public static readonly MicroResource LargeCapacityPowerRegulator = new MicroResource("LargeCapacityPowerRegulator", MicroResourceCategory.Component, 128965842);
        public static readonly MicroResource Lazarus = new MicroResource("Lazarus", MicroResourceCategory.Component, 128962603);
        public static readonly MicroResource MicrobialInhibitor = new MicroResource("MicrobialInhibitor", MicroResourceCategory.Component, 128962604);
        public static readonly MicroResource MutagenicCatalyst = new MicroResource("MutagenicCatalyst", MicroResourceCategory.Component, 128961571);
        public static readonly MicroResource NutritionalConcentrate = new MicroResource("NutritionalConcentrate", MicroResourceCategory.Component, 128962605);
        public static readonly MicroResource PersonalComputer = new MicroResource("PersonalComputer", MicroResourceCategory.Component, 128961584);
        public static readonly MicroResource PersonalDocuments = new MicroResource("PersonalDocuments", MicroResourceCategory.Component, 128962606);
        public static readonly MicroResource PetrifiedFossil = new MicroResource("PetrifiedFossil", MicroResourceCategory.Component, 128961586);
        public static readonly MicroResource Push = new MicroResource("Push", MicroResourceCategory.Component, 128962607);
        public static readonly MicroResource PyrolyticCatalyst = new MicroResource("PyrolyticCatalyst", MicroResourceCategory.Component, 128965835);
        public static readonly MicroResource RefinementProcessSample = new MicroResource("RefinementProcessSample", MicroResourceCategory.Component, 128965839);
        public static readonly MicroResource ShipSchematic = new MicroResource("ShipSchematic", MicroResourceCategory.Component, 128962608);
        public static readonly MicroResource SuitSchematic = new MicroResource("SuitSchematic", MicroResourceCategory.Component, 128962609);
        public static readonly MicroResource SurveillanceEquipment = new MicroResource("SurveillanceEquipment", MicroResourceCategory.Component, 128962610);
        public static readonly MicroResource SyntheticGenome = new MicroResource("SyntheticGenome", MicroResourceCategory.Component, 128961590);
        public static readonly MicroResource SyntheticPathogen = new MicroResource("SyntheticPathogen", MicroResourceCategory.Component, 128962611);
        public static readonly MicroResource TrueFormFossil = new MicroResource("TrueFormFossil", MicroResourceCategory.Component, 128961591);
        public static readonly MicroResource UniversalTranslator = new MicroResource("UniversalTranslator", MicroResourceCategory.Component, 128962612);
        public static readonly MicroResource VehicleSchematic = new MicroResource("VehicleSchematic", MicroResourceCategory.Component, 128962613);
        public static readonly MicroResource WeaponSchematic = new MicroResource("WeaponSchematic", MicroResourceCategory.Component, 128962614);
