...
namespace EddiDataDefinitions
{
    public class ShipDefinitions
    {
        private static Dictionary<long, Ship> ShipsByEliteID = new Dictionary<long, Ship>()
        {
            ...
            { 128049303, new Ship(128049303, "Asp", "Lakon Spaceways", null, "Asp Explorer", null, "Medium") },
            { 128672276, new Ship(128672276, "Asp_Scout", "Lakon Spaceways", null, "Asp Scout", null, "Medium") },
            { 111, new Ship(111, "BelugaLiner", "Saud Kruger", new List<Translation> {new Translation("Saud", "saʊd"), new Translation("Kruger", "ˈkruːɡə") }, "Beluga", new List<Translation> {new Translation("beluga", "bɪˈluːɡə") }, "Large") },
            ...
            { 128671831, new Ship(128671831, "DiamondbackXL", "Lakon Spaceways", null, "Diamondback Explorer", null, "Small") },
            { 128671217, new Ship(128671217, "Diamondback", "Lakon Spaceways", null, "Diamondback Scout", null, "Small") },
            ...
            { 128672269, new Ship(128672269, "Independant_Trader", "Lakon Spaceways", null, "Keelback", null, "Medium") },
            ...
            { 128049285, new Ship(128049285, "Type6", "Lakon Spaceways", null, "Type-6 Transporter", null, "Medium") },
            { 128049297, new Ship(128049297, "Type7", "Lakon Spaceways", null, "Type-7 Transporter", null, "Large") },
            { 128049333, new Ship(128049333, "Type9", "Lakon Spaceways", null, "Type-9 Heavy", null, "Large") },
