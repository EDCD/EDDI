...
namespace EddiDataDefinitions
{
    ...
    public class StarClass
    {
        static StarClass()
        {
            ...
            var G = new StarClass("G", "G", new Chromaticity("yellow_white"), 7.3987M, new Normal(5.1069, 0.4008), new Normal(0.9292, 0.1118), new Normal(0.9568, 0.1923), new Normal(5542.6589, 226.6528), new Normal(4486.2856, 3844.6356), new Normal(835803.0344, 1925153.7693), new Normal(54.9342, 97.6532), new Normal(0.1506, 0.1192), new Normal(0.1455, 45.1510), new Normal(178.9063, 104.0538), new Normal(3.8664, 2.0384), null, new Normal(2064.8964, 421.6909));
            ...
            var M_RedSuperGiant = new StarClass("M_RedSuperGiant", "M_RedSuperGiant", new Chromaticity("red"), 4.6459e-3M, new Normal(-2.5554, 0.6366), new Normal(2.1794, 1.6778), new Normal(75.3733, 155.7319), new Normal(4643.1662, 745.0649), new Normal(2621.7213, 2968.7888), new Normal(749591.2234, 1395061.6018), new Normal(49.4475, 80.7911), new Normal(0.1618, 0.1322), new Normal(-2.0251, 44.6415), new Normal(178.9133, 104.1287), new Normal(75.6222, 415.9329), new Normal(0.1061, 0.1048), new Normal(5.9106e-2, 3.9906e-2));
            ...
            var M_RedGiant = new StarClass("M_RedGiant", "M_RedGiant", new Chromaticity("red"), 0.1637M, new Normal(6.9335, 4.8211), new Normal(0.3664, 0.2577), new Normal(4.0907, 10.1551), new Normal(2429.3432, 230.5779), new Normal(7493.5638, 3924.2886), new Normal(1072124.3879, 2588950.7977), new Normal(70.7003, 134.0570), new Normal(0.1420, 0.1212), new Normal(1.5043, 44.3672), new Normal(180.2272, 104.7395), new Normal(42.4517, 64.9349), null, new Normal(4190.7421, 1555.3823));
