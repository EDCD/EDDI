...
namespace EddiDataDefinitions
{
    public class StationModel : ResourceBasedLocalizedEDName<StationModel>
    {
        ...
        public static readonly StationModel None = new("None");
        public static readonly StationModel AsteroidBase = new("AsteroidBase");
        public static readonly StationModel Bernal = new("Bernal");
        public static readonly StationModel Coriolis = new("Coriolis");
        public static readonly StationModel Megaship = new("Megaship");
        public static readonly StationModel MegaShipCivilian = new("MegaShipCivilian");
        public static readonly StationModel Ocellus = new("Ocellus");
        public static readonly StationModel Orbis = new("Orbis");
        public static readonly StationModel Dodec = new("Dodec");
        public static readonly StationModel Outpost = new("Outpost");
        public static readonly StationModel SurfaceStation = new("SurfaceStation"); // No longer used in the player journal
        public static readonly StationModel CraterOutpost = new("CraterOutpost");
        public static readonly StationModel CraterPort = new("CraterPort");
        public static readonly StationModel OutpostScientific = new("OutpostScientific");
        public static readonly StationModel FleetCarrier = new("FleetCarrier");
        public static readonly StationModel OnFootSettlement = new("OnFootSettlement");
