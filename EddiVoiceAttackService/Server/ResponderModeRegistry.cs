...
namespace EddiVoiceAttackService.Server
{
    ...
    public static class ResponderModeRegistry
    {
        ...
        private static Func<bool, CancellationToken, Task>? handler;

        /// <summary>
        /// Gets the registered responder mode handler.
        /// </summary>
        public static Func<bool, CancellationToken, Task>? Handler
        {
            get
            {
                lock ( sync )
        ...
        public static void RegisterHandler( Func<bool, CancellationToken, Task> responderModeHandler )
        {
