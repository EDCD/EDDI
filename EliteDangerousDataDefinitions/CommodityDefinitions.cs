...
namespace EliteDangerousDataDefinitions
{
    public class CommodityDefinitions
    {
        ...
        private static Dictionary<long, Commodity> CommoditiesByEliteID = new Dictionary<long, Commodity>
        {
            ...
            {128049212, new Commodity(10, "Narcotics", "Legal Drugs", 9966, false) },
            ...
            {128064028, new Commodity(25, "Atmospheric Processors", "Machinery", 357, false) },
            {128049222, new Commodity(26, "Crop Harvesters", "Machinery", 2021, false) },
            {128049223, new Commodity(27, "Marine Equipment", "Machinery", 3916, false) },
            {128049220, new Commodity(28, "Microbial Furnaces", "Machinery", 236, false) },
            ...
            {128049208, new Commodity(32, "Agri-Medicines", "Medicines", 1038, false) },
            ...
            {128049228, new Commodity(64, "Auto-Fabricators", "Technology", 3734, false) },
            {128049672, new Commodity(65, "Bioreducing Lichen", "Technology", 998, false) },
            {128049225, new Commodity(66, "Computer Components", "Technology", 513, false) },
            {128049226, new Commodity(67, "H.E. Suits", "Technology", 340, false) },
            {128049232, new Commodity(68, "Land Enrichment Systems", "Technology", 4887, false) },
            ...
            {128049236, new Commodity(78, "Non-lethal Weapons", "Weapons", 1837, false) },
            ...
            {128066403, new Commodity(84, "Limpet", "Unknown", 101, false) },
            {128668548, new Commodity(95, "Ai Relics", "Salvage", 138613, false) },
            {128668551, new Commodity(96, "Antiquities", "Salvage", 115511, false) },
            {128671118, new Commodity(97, "Osmium", "Metals", 7591, false) },
            {128671443, new Commodity(98, "Sap 8 Core Container", "Salvage", 59196, false) },
            {128671444, new Commodity(99, "Trinkets Of Hidden Fortune", "Salvage", 1428, false) },
            {128666754, new Commodity(100, "Trade Data", "Salvage", 2790, false) },
            {128672308, new Commodity(101, "Thermal Cooling Units", "Machinery", 256, false) },
            {128672313, new Commodity(102, "Skimmer Components", "Machinery", 859, false) },
            ...
            {128672701, new Commodity(114, "Meta-Alloys", "Industrial Materials", 88148, false) },
            ...
            {128672310, new Commodity(124, "Muon Imager", "Technology", 6353, false) },
            {128666755, new Commodity(127, "Military Plans", "Salvage", 9413, false) },
            {128666756, new Commodity(128, "Ancient Artefact", "Salvage", 8183, false) },
            {128666758, new Commodity(130, "Experimental Chemicals", "Salvage", 3524, false) },
            {128666759, new Commodity(131, "Rebel Transmissions", "Salvage", 4068, false) },
            {128666760, new Commodity(132, "Prototype Tech", "Salvage", 10696, false) },
            {128666761, new Commodity(133, "Technical Blueprints", "Salvage", 6333, false) },
            {128668547, new Commodity(246, "Unknown Artefact", "Salvage", 290190, false) },
            {128668549, new Commodity(247, "Hafnium 178", "Metals", 69098, false) },
            ...
            {128673856, new Commodity(283, "CMM Composite", "Industrial Materials", 3132, false) },
            {128673859, new Commodity(286, "Articulation Motors", "Machinery", 4997, false) },
            {128673860, new Commodity(287, "HN Shock Mount", "Machinery", 406, false) },
