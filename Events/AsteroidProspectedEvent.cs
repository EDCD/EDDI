...
{
    [PublicAPI]
    public class AsteroidProspectedEvent (
        DateTime timestamp,
        List<CommodityPresence> commodities,
        AsteroidMaterialContent materialContent,
        decimal remaining,
        CommodityDefinition motherlodeCommodityDefinition )
        : Event( timestamp, NAME )
    {
        ...
        public List<CommodityPresence> commodities { get; private set; } = commodities;
        ...
        public AsteroidMaterialContent materialContent { get; private set; } = materialContent;

        public CommodityDefinition motherlodeCommodityDefinition { get; private set; } = motherlodeCommodityDefinition;
    }
}