...
{
    [PublicAPI]
    public class BackpackEvent ( DateTime timestamp, List<MicroResourceAmount> inventory ) : Event( timestamp, NAME )
    {
        ...
        [PublicAPI("The backpack items that you are carrying (as a list of objects with `name`, `category`, and `amount` properties)")]
