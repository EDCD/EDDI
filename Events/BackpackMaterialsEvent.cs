...
namespace EddiEvents
{
    public class BackpackMaterialsEvent : Event
    {
        ...
        public BackpackMaterialsEvent(DateTime timestamp, List<MicroResourceAmount> components, List<MicroResourceAmount> consumables, List<MicroResourceAmount> data, List<MicroResourceAmount> items) : base(timestamp, NAME)
        {
