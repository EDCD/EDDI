...
{
    [PublicAPI]
    public class DataVoucherAwardedEvent ( DateTime timestamp, string payeefaction, string victimfaction, long reward )
        : Event( timestamp, NAME )
    {
        ...
        public string payeefaction { get; private set; } = payeefaction;
    }

    public class Reward ( string faction, long amount )
    {
        [PublicAPI]
