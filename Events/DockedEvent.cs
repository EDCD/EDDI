...
namespace EddiEvents
{
    public class DockedEvent : Event
    {
        ...
        public const string SAMPLE = @"{ ""timestamp"":""2018-11-11T19:44:46Z"", ""event"":""Docked"", ""StationName"":""Houssay Ring"", ""StationType"":""Bernal"", ""StarSystem"":""Aasgananu"", ""SystemAddress"":9466510452105, ""MarketID"":3223340032, ""StationFaction"":""Aasgananu Bridge Solutions"", ""FactionState"":""Boom"", ""StationGovernment"":""$government_Corporate;"", ""StationGovernment_Localised"":""Corporate"", ""StationAllegiance"":""Federation"", ""StationServices"":[ ""Dock"", ""Autodock"", ""Commodities"", ""Contacts"", ""Exploration"", ""Missions"", ""Outfitting"", ""CrewLounge"", ""Rearm"", ""Refuel"", ""Repair"", ""Shipyard"", ""Tuning"", ""Workshop"", ""MissionsGenerated"", ""FlightController"", ""StationOperations"", ""Powerplay"", ""SearchAndRescue"" ], ""StationEconomy"":""$economy_Industrial;"", ""StationEconomy_Localised"":""Industrial"", ""StationEconomies"":[ { ""Name"":""$economy_Industrial;"", ""Name_Localised"":""Industrial"", ""Proportion"":0.770000 }, { ""Name"":""$economy_Extraction;"", ""Name_Localised"":""Extraction"", ""Proportion"":0.230000 } ], ""DistFromStarLS"":11.883362 }";
