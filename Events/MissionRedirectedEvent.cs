...
namespace EddiEvents
{
    public class MissionRedirectedEvent: Event
    {
        ...
        public MissionRedirectedEvent(DateTime timestamp, long? missionid, string newdestinationstation, string olddestinationstation, string newdestinationsystem, string olddestinationsystem) : base(timestamp, NAME)
        {
