...
{
    [ PublicAPI ]
    public class PowerMicroResourcesCollectedEvent (
        DateTime timestamp,
        long marketId,
        ...
        : Event( timestamp, NAME )
    {
        ...
        public long marketId { get; private set; } = marketId; // Tourist beacons and guardian structures are reported as settlements without MarketID 
    }
}
