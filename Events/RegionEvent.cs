...
{
    [PublicAPI]
    public class RegionEvent : Event
    {
        public const string NAME = "Region";
        public const string DESCRIPTION = "Triggered when you enter a new region.";
        ...
        public RegionEvent (DateTime timestamp, Region region) : base(timestamp, NAME)
        {
