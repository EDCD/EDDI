...
namespace EliteDangerousEvents
{
    public class ShipInterdictedEvent : Event
    {
        ...
        static ShipInterdictedEvent()
        {
            ...
            VARIABLES.Add("interdictor", "The name of the commander carrying out the interdiction");
            VARIABLES.Add("rating", "The combat rating of the commander carrying out the interdiction");
            VARIABLES.Add("faction", "The faction of the commander carrying out the interdiction");
            VARIABLES.Add("power", "The power of the commander carrying out the interdiction");
        }
