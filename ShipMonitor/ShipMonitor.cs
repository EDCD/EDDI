...
namespace EddiShipMonitor
{
    public class ShipMonitor : IEddiMonitor
    {
        ...
        public void Stop()
        {
            profileRefreshCancellationTokenSource.Cancel();
        }
        ...
        internal void handleShipLoadoutEvent(ShipLoadoutEvent @event)
        {
            if (@event.timestamp > updatedAt)
            {
                ...
                if (!inFighter(@event.edModel))
                {
                    ...
                    ReplaceOrAddShip( ship );
                    EDDI.Instance.UpdateCurrentShip( ship );
        ...
        public Ship GetCurrentShip()
        {
            ...
            EDDI.Instance.UpdateCurrentShip( currentShip ?? EDDI.Instance.GameState.CurrentShip );
            return currentShip;
        }
    ...
    public class ShipRoleConverter : IValueConverter
    {
