...
namespace EddiSpeechService.SpeechConversions
{
    public static partial class SpeechConversions
    {
        ...
        private static readonly Dictionary<string, string[]> CATALOG_FIXUPS = new()
        {
            ...
            { "Gl " , [ $@"<phoneme alphabet=""ipa"" ph=""{Phonetics.Gliese}"">Gliese</phoneme> " ] }, // Abbreviation for "Gliese"
            { "Gliese" , [ $@"<phoneme alphabet=""ipa"" ph=""{Phonetics.Gliese}"">Gliese</phoneme>" ] }, // Gliese Catalogue of Nearby Stars
            { "Lalande" , [ $@"<phoneme alphabet=""ipa"" ph=""{Phonetics.Lalande}"">Lalande</phoneme>" ] }, // Histoire Céleste Française, e.g. "Lalande 1234"
            { "Luyten" , [ $@"<phoneme alphabet=""ipa"" ph=""{Phonetics.Luyten}"">Luyten</phoneme>" ] }, // Luyten, e.g. "Luyten 143-23"
            { "2MASS" , [ "2", "mass" ] }, // Two Micron All-Sky Survey, e.g. "2MASS J07464256+2000321 A or 2MASS 1503+2525"
        };
