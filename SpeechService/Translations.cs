            ...
            if (number < 100)
            {
                ...
                switch (nextDigit)
                {
                    case 1:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinus, number) : string.Format(Properties.Phrases.justOver, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusThousand, number) : string.Format(Properties.Phrases.justOverThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusMillion, number) : string.Format(Properties.Phrases.justOverMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusBillion, number) : string.Format(Properties.Phrases.justOverBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusTrillion, number) : string.Format(Properties.Phrases.justOverTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusQuadrillion, number) : string.Format(Properties.Phrases.justOverQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.justOverMinusQuintillion, number) : string.Format(Properties.Phrases.justOverQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 2:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.overMinus, number) : string.Format(Properties.Phrases.over, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusThousand, number) : string.Format(Properties.Phrases.overThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusMillion, number) : string.Format(Properties.Phrases.overMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusBillion, number) : string.Format(Properties.Phrases.overBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusTrillion, number) : string.Format(Properties.Phrases.overTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusQuadrillion, number) : string.Format(Properties.Phrases.overQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusQuintillion, number) : string.Format(Properties.Phrases.overQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 3:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinus, number) : string.Format(Properties.Phrases.wellOver, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusThousand, number) : string.Format(Properties.Phrases.wellOverThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusMillion, number) : string.Format(Properties.Phrases.wellOverMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusBillion, number) : string.Format(Properties.Phrases.wellOverBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusTrillion, number) : string.Format(Properties.Phrases.wellOverTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusQuadrillion, number) : string.Format(Properties.Phrases.wellOverQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusQuintillion, number) : string.Format(Properties.Phrases.wellOverQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 4:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusAndAHalf, number) : string.Format(Properties.Phrases.nearlyAndAHalf, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusThousandAndAHalf, number) : string.Format(Properties.Phrases.nearlyThousandAndAHalf, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusMillionAndAHalf, number) : string.Format(Properties.Phrases.nearlyMillionAndAHalf, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusBillionAndAHalf, number) : string.Format(Properties.Phrases.nearlyBillionAndAHalf, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusTrillionAndAHalf, number) : string.Format(Properties.Phrases.nearlyTrillionAndAHalf, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuadrillionAndAHalf, number) : string.Format(Properties.Phrases.nearlyQuadrillionAndAHalf, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuintillionAndAHalf, number) : string.Format(Properties.Phrases.nearlyQuintillionAndAHalf, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 5:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalf, number) : string.Format(Properties.Phrases.aroundAndAHalf, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfThousand, number) : string.Format(Properties.Phrases.aroundAndAHalfThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfMillion, number) : string.Format(Properties.Phrases.aroundAndAHalfMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfBillion, number) : string.Format(Properties.Phrases.aroundAndAHalfBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfTrillion, number) : string.Format(Properties.Phrases.aroundAndAHalfTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfQuadrillion, number) : string.Format(Properties.Phrases.aroundAndAHalfQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.aroundMinusAndAHalfQuintillion, number) : string.Format(Properties.Phrases.aroundAndAHalfQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 6:
                    case 7:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalf, number) : string.Format(Properties.Phrases.overAndAHalf, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfThousand, number) : string.Format(Properties.Phrases.overAndAHalfThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfMillion, number) : string.Format(Properties.Phrases.overAndAHalfMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfBillion, number) : string.Format(Properties.Phrases.overAndAHalfBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfTrillion, number) : string.Format(Properties.Phrases.overAndAHalfTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfQuadrillion, number) : string.Format(Properties.Phrases.overAndAHalfQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.overMinusAndAHalfQuintillion, number) : string.Format(Properties.Phrases.overAndAHalfQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 8:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalf, number) : string.Format(Properties.Phrases.wellOverAndAHalf, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfThousand, number) : string.Format(Properties.Phrases.wellOverAndAHalfThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfMillion, number) : string.Format(Properties.Phrases.wellOverAndAHalfMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfBillion, number) : string.Format(Properties.Phrases.wellOverAndAHalfBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfTrillion, number) : string.Format(Properties.Phrases.wellOverAndAHalfTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfQuadrillion, number) : string.Format(Properties.Phrases.wellOverAndAHalfQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.wellOverMinusAndAHalfQuintillion, number) : string.Format(Properties.Phrases.wellOverAndAHalfQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    case 9:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinus, number) : string.Format(Properties.Phrases.nearly, number + 1);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusThousand, number) : string.Format(Properties.Phrases.nearlyThousand, number + 1);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusMillion, number) : string.Format(Properties.Phrases.nearlyMillion, number + 1);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusBillion, number) : string.Format(Properties.Phrases.nearlyBillion, number + 1);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusTrillion, number) : string.Format(Properties.Phrases.nearlyTrillion, number + 1);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuadrillion, number) : string.Format(Properties.Phrases.nearlyQuadrillion, number + 1);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuintillion, number) : string.Format(Properties.Phrases.nearlyQuintillion, number + 1);
                            default:
                                return $"{rawValue}";
                        }
                    default:
            ...
            else
            {
                ...
                switch (nextDigit)
                {
                    ...
                    case 9:
                        ...
                        {
                            case 1:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinus, number) : string.Format(Properties.Phrases.nearly, number);
                            case 1E3M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusThousand, number) : string.Format(Properties.Phrases.nearlyThousand, number);
                            case 1E6M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusMillion, number) : string.Format(Properties.Phrases.nearlyMillion, number);
                            case 1E9M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusBillion, number) : string.Format(Properties.Phrases.nearlyBillion, number);
                            case 1E12M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusTrillion, number) : string.Format(Properties.Phrases.nearlyTrillion, number);
                            case 1E15M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuadrillion, number) : string.Format(Properties.Phrases.nearlyQuadrillion, number);
                            case 1E18M:
                                return isNegative ? string.Format(Properties.Phrases.nearlyMinusQuintillion, number) : string.Format(Properties.Phrases.nearlyQuintillion, number);
                            default:
                                return $"{rawValue}";
                        }
                    default:
