...
namespace Tests
{
    ...
    public class BodyScanTests
    {
        ...
        public void TestBodyScanDagutiiABC1b()
        {
            ...
            Event @event = EddiJournalMonitor.JournalMonitor.ParseJournalEntry(data);

            Assert.IsNotNull(@event);

            Assert.IsTrue(@event is BodyScannedEvent);
            BodyScannedEvent bsEvent = (BodyScannedEvent)@event;
