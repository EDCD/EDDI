...
";
        ...
        public void TestCommanderFromProfile3()
        {
            ...
            Assert.AreEqual("https://coriolis.io/outfit/imperial_cutter/08A8A7A7D7A7D6C7n7l7l2k2k1c1c0304030404040407074f053c04042f24.Iw18ZpAA.CwBj4RnabCofEQAA", shipUri);
        }
        ...
        public void TestCommanderFromProfile4()
        {
            ...
            Assert.AreEqual(0, cmdr.Ship.Cargo.Count);
        }
    }
}
