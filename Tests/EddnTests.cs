...
namespace Tests
{
    ...
    public class EddnTests : TestBase
    {
        ...
        private async Task<EDDNResponder> CreateEddnResponderAsync()
        {
            ...
            FakeSpanshHttpClient.Expect( "system/1183229809290", Encoding.UTF8.GetString( Resources.SpanshQuickStarSystemPleiadesSector_GW_W_c1_4 ) );
            FakeSpanshHttpClient.Expect( "system/10477373803", Encoding.UTF8.GetString( Resources.SpanshQuickStarSystemSol ) );
            FakeSpanshHttpClient.Expect( "system/5068463809865", Encoding.UTF8.GetString( Resources.SpanshQuickStarSystemHyadesSector_DL_X_b1_2 ) );
            FakeSpanshHttpClient.Expect( "system/35835461971465", Encoding.UTF8.GetString( Resources.SpanshQuickStarSystemOmegaSector_DM_M_b7_16 ) );
            FakeSpanshHttpClient.Expect( "system/3107509474002", Encoding.UTF8.GetString( Resources.SpanshQuickStarSystemArtemis ) );
        ...
        [TestMethod]
        public async Task TestEddnSchemaInitialization()
        {
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            Assert.IsTrue( responder.schemas.Any() );
            Assert.IsTrue( responder.capiSchemas.Any() );
        }

        [TestMethod]
        public async Task TestEDDNResponderGoodMatch()
        {
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestEDDNResponderMismatchedStarPos ()
        {
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestEDDNResponderMismatchedSystemAddress ()
        {
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
        ...
        [TestMethod]
        public async Task TestEDDNResponderMismatchedName ()
        {
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
        ...
        public async Task TestRawJournalEventLocationData()
        {
        ...
        [ TestMethod ]
        public async Task commoditySchemaJournalTest ()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var commoditySchema = responder.schemas
        ...
        [TestMethod]
        public async Task commoditySchemaCapiTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var commoditySchema = responder
        ...
        [TestMethod]
        public async Task fcmaterialsSchemaJournalTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var fcmaterialsSchema = responder
        ...
        [TestMethod]
        public async Task fcmaterialsSchemaCapiTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var fcmaterialsSchema = responder
        ...
        [TestMethod]
        public async Task outfittingSchemaJournalTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var outfittingSchema = responder
        ...
        [TestMethod]
        public async Task outfittingSchemaCapiTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var outfittingSchema = responder
        ...
        [TestMethod]
        public async Task shipyardSchemaJournalTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var shipyardSchema = responder
        ...
        [TestMethod]
        public async Task shipyardSchemaCapiTest()
        {
            // Set up our schema
            var responder = await CreateEddnResponderAsync().ConfigureAwait(false);
            var shipyardSchema = responder.capiSchemas.FirstOrDefault(s => s.GetType() == typeof(ShipyardSchema));
