...
namespace Tests
{
    ...
    public class EddnTests : TestBase
    {
        ...
        public void TestEDDNResponderGoodMatch()
        {
            ...
            var nameOk = responder.eddnState.Location.ConfirmName();
            var coordinatesOk = responder.eddnState.Location.ConfirmCoordinates();

            Assert.IsTrue( nameOk );
            Assert.IsTrue( coordinatesOk );
        ...
        public void TestEDDNResponderMismatchedStarPos ()
        {
            ...
            var confirmed = responder.eddnState.Location.ConfirmCoordinates();
        ...
        public void TestEDDNResponderMismatchedSystemAddress ()
        {
            ...
            var confirmed = responder.eddnState.Location.ConfirmName();
        ...
        public async Task TestEDDNResponderDockedEvent()
        {
            ...
            var responder = CreateEddnResponder();
            await responder.HandleAsync(jumpedEvent).ConfigureAwait(false);
            await responder.HandleAsync(dockedEvent).ConfigureAwait(false);
