...
namespace UnitTests
{
    ...
    public class EdsmDataTests
    {
        ...
        public void TestBodies()
        {
            ...
            Assert.AreEqual(66.83109999999999, (double)body.solidComposition[0].percent, 0.01);
            ...
            Assert.AreEqual("Rock", body.solidComposition[0].composition.invariantName);
            Assert.AreEqual(70, (double)body.solidComposition[0].percent, 0.01);
            Assert.AreEqual("Metal", body.solidComposition[1].composition.invariantName);
            ...
            Assert.AreEqual("Ice", body.solidComposition[0].composition.invariantName);
            Assert.AreEqual(81.6586, (double)body.solidComposition[0].percent, 0.01);
            Assert.AreEqual("Rock", body.solidComposition[1].composition.invariantName);
            Assert.AreEqual(16.653200000000002, (double)body.solidComposition[1].percent, 0.01);
            Assert.AreEqual("Metal", body.solidComposition[2].composition.invariantName);
