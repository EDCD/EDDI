...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        [TestMethod, DoNotParallelize]
        public async Task TestJumpEvent3Async()
        {
            EDDI.Instance.DataProvider = CreateTestDataProvider();
            ...
            FakeSpanshHttpClient.Expect( "dump/33656303199641", Encoding.UTF8.GetString( Properties.Resources.SpanshStarSystemDumpLHS_20 ) );
            EDDI.Instance.GameStateMutator.LastStarSystem = new StarSystem { systemname = "TestSystem", systemAddress = 6606892846276 };
        ...
        public void TestSignalDetectedEvent2()
        {
            ...
            Assert.AreEqual( 2385.8156739M, @event.secondsremaining);
        }
        ...
        {
            EDDI.Instance.GameStateMutator.CurrentStarSystem = new StarSystem { systemname = "TestSystem", systemAddress = 6606892846276 };
            ...
            EDDI.Instance.EventProcessor.eventSignalDetected( event0 );
            ...
            EDDI.Instance.EventProcessor.eventSignalDetected( event1 );
            ...
            EDDI.Instance.EventProcessor.eventSignalDetected( event2 );
            ...
            EDDI.Instance.EventProcessor.eventSignalDetected( event3 );
            ...
            EDDI.Instance.EventProcessor.eventSignalDetected( event4 );
        ...
        [TestMethod, DoNotParallelize]
        public async Task TestExplorationSequenceAsync()
        {
            EDDI.Instance.GameStateMutator.CurrentStarSystem = new StarSystem { systemname = "Flyae Drye HT-X b48-1", systemAddress = 2830785848739 };
            ...
            EDDI.Instance.GameStateMutator.NextStarSystem = nextSystem;
