    ...
    public class ShipMonitorTests : TestBase
    {
        ...
        public async Task TestShipScenarioAsync1 ()
        {
            ...
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:14:37Z"", ""event"":""ShipyardBuy"", ""ShipType"":""empire_courier"", ""ShipPrice"":2231423, ""StoreOldShip"":""SideWinder"", ""StoreShipID"":901, ""MarketID"":128132856 }",
                shipMonitor ).ConfigureAwait( false );
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:14:38Z"", ""event"":""Cargo"", ""Inventory"":[ ] }",
                shipMonitor ).ConfigureAwait( false );
            ...
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:17:15Z"", ""event"":""ShipyardSwap"", ""ShipType"":""sidewinder"", ""ShipID"":901, ""StoreOldShip"":""Empire_Courier"", ""StoreShipID"":902, ""MarketID"":128666762 }",
                shipMonitor ).ConfigureAwait( false );
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:17:16Z"", ""event"":""Cargo"", ""Inventory"":[ ] }",
                shipMonitor ).ConfigureAwait( false );
            ...
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:18:35Z"", ""event"":""ShipyardSwap"", ""ShipType"":""empire_courier"", ""ShipID"":902, ""StoreOldShip"":""SideWinder"", ""StoreShipID"":901, ""MarketID"":128666762 }",
                shipMonitor ).ConfigureAwait( false );
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:18:36Z"", ""event"":""Cargo"", ""Inventory"":[ ] }",
                shipMonitor ).ConfigureAwait( false );
            ...
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:21:03Z"", ""event"":""ShipyardSwap"", ""ShipType"":""sidewinder"", ""ShipID"":901, ""StoreOldShip"":""Empire_Courier"", ""StoreShipID"":902, ""MarketID"":128666762 }",
                shipMonitor ).ConfigureAwait( false );
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:21:04Z"", ""event"":""Cargo"", ""Inventory"":[ ] }",
                shipMonitor ).ConfigureAwait( false );
            ...
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:21:47Z"", ""event"":""ShipyardSwap"", ""ShipType"":""empire_courier"", ""ShipID"":902, ""StoreOldShip"":""SideWinder"", ""StoreShipID"":901, ""MarketID"":128666762 }",
                shipMonitor ).ConfigureAwait( false );
            await SendEventsAsync( @"{ ""timestamp"":""2017-04-24T08:21:48Z"", ""event"":""Cargo"", ""Inventory"":[ ] }",
                shipMonitor ).ConfigureAwait( false );
