    ...
    public class SpeechTests
    {
        ...
        public void TestPhonemes()
        {
            ...
            using (SpeechSynthesizer synth = new SpeechSynthesizer())
            {
                ...
                synth.SpeakSsml("<?xml version=\"1.0\" encoding=\"UTF-8\"?><speak version=\"1.0\" xmlns=\"http://www.w3.org/2001/10/synthesis\" xml:lang=\"en-GB\"><s>This is your <phoneme alphabet=\"ipa\" ph=\"ˈiːɡəl\">Eagle</phoneme>.</s></speak>");
