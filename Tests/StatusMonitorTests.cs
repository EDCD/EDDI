...
namespace Tests
{
    ...
    public class StatusMonitorTests : TestBase
    {
        ...
        public void TestParseStatusFlagsDocked ()
        {
            ...
            Assert.IsFalse( status.fsd_supercruise_boosting );
            Assert.IsFalse( status.fsd_supercruise_charging );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:04:13Z\", \"event\":\"Status\", \"Flags\":151060493, \"Flags2\":0, \"Pips\":[4,8,0], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":32.000000, \"FuelReservoir\":0.630000 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\" }";
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T23:10:06Z\", \"event\":\"Status\", \"Flags\":16842761, \"Flags2\":2, \"Pips\":[4,4,4], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":8.000000, \"FuelReservoir\":0.570000 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\" }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T22:30:27Z\", \"event\":\"Status\", \"Flags\":16777240, \"Flags2\":2, \"Pips\":[4,4,4], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":8.000000, \"FuelReservoir\":0.360000 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\" }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:15:30Z\", \"event\":\"Status\", \"Flags\":34078792, \"Flags2\":0, \"Pips\":[2,8,2], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":0.000000, \"FuelReservoir\":0.240000 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\" }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:24:57Z\", \"event\":\"Status\", \"Flags\":153157646, \"Flags2\":0, \"Pips\":[4,8,0], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":32.000000, \"FuelReservoir\":0.384769 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\", \"Latitude\":40.761524, \"Longitude\":65.103111, \"Heading\":32, \"Altitude\":0, \"BodyName\":\"Nervi 2 a\", \"PlanetRadius\":866740.562500 }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:26:19Z\", \"event\":\"Status\", \"Flags\":203423752, \"Flags2\":0, \"Pips\":[7,4,1], \"FireGroup\":0, \"GuiFocus\":0, \"Fuel\":{ \"FuelMain\":0.000000, \"FuelReservoir\":0.447595 }, \"Cargo\":0.000000, \"LegalState\":\"Clean\", \"Latitude\":40.745747, \"Longitude\":65.096542, \"Heading\":159, \"Altitude\":0, \"BodyName\":\"Nervi 2 a\", \"PlanetRadius\":866740.562500 }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:30:38Z\", \"event\":\"Status\", \"Flags\":2097152, \"Flags2\":273, \"Oxygen\":1.000000, \"Health\":1.000000, \"Temperature\":163.527100, \"SelectedWeapon\":\"$humanoid_fists_name;\", \"SelectedWeapon_Localised\":\"Unarmed\", \"Gravity\":0.101595, \"LegalState\":\"Clean\", \"Latitude\":40.741016, \"Longitude\":65.076881, \"Heading\":-165, \"BodyName\":\"Nervi 2 a\" }";
            var status = statusService.ParseStatusEntry( line );
        ...
        {
            var line =
                "{ \"timestamp\":\"2021-05-01T21:00:10Z\", \"event\":\"Status\", \"Flags\":0, \"Flags2\":9, \"Oxygen\":1.000000, \"Health\":1.000000, \"Temperature\":293.000000, \"SelectedWeapon\":\"\", \"LegalState\":\"Clean\", \"BodyName\":\"Savitskaya Vision\" }";
            var status = statusService.ParseStatusEntry( line );
        ...
        public void TestStatusMonitorHandleStatus (string line)
        {
            ...
            var variables = statusMonitor.GetVariables().ToRuntimeValueDictionary();
