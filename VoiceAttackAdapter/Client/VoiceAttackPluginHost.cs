...
namespace EddiVoiceAttackAdapter.Client
{
    ...
    public class VoiceAttackPluginHost
    {
        ...
        /// <summary>
        /// Making this private prevents direct instantiation. Use the <see cref="Instance"/> property instead.
        /// </summary>
        ...
        public async Task InitializeAsync(CancellationToken cancellationToken = default)
        {
            ...
            // If we previously attempted initialization but did not connect (e.g., config not yet written,
            // server not yet accepting connections), allow subsequent calls to retry.
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                {
                    parameters["voiceAttackVersion"] = voiceAttackVersion.ToString();
                }
